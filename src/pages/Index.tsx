        ...
        <div className="container-narrow">
          ...
          <div className="flex flex-col gap-3 mb-6 mt-12">
            ...
            <div className="mt-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">Walk away with real AI Skills you can deploy to your team from day one.</p>
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div key={skill.title} className="rounded-xl border border-border bg-surface p-4">
